...
export function GuardrailsTab({ activity }: GuardrailsTabProps) {
    ...
    return (
      <div className="space-y-4">
        <div className="rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 shadow-sm p-10 text-center">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-salmon-50 dark:bg-navy-950/40 mb-4">
            <Bell className="w-6 h-6 text-salmon-500" />
          </div>
          ...
          <button
            onClick={openNew}
            className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm font-semibold bg-salmon-600 hover:bg-salmon-700 text-white transition-colors"
          >
  ...
  const newFormCard = showNewForm && (
    <div className="rounded-2xl bg-salmon-50/60 dark:bg-navy-950/20 border border-salmon-200 dark:border-navy-800/40 shadow-sm p-5 space-y-4">
      <p className="text-xs font-semibold text-salmon-700 dark:text-salmon-300 uppercase tracking-wide">New Alert</p>
      <div className="flex flex-wrap gap-3 items-end">
        ...
        <div>
          ...
          <select
            ...
            className="px-2.5 py-1.5 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-sm text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-salmon-400 min-w-[160px]"
          >
        ...
        <div>
          ...
          <input
            ...
            placeholder="e.g. 750"
            className="px-2.5 py-1.5 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-sm text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-salmon-400 w-28"
          />
        </div>
        {/* Warning pct */}
        <div>
          ...
          <div className="flex items-center gap-1.5">
            <input
              ...
              className="px-2.5 py-1.5 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-sm text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-salmon-400 w-16"
            />
        ...
        <div className="flex gap-2 pb-0.5">
          <button
            ...
            disabled={savingNew}
            className="px-4 py-1.5 rounded-lg text-xs font-bold bg-salmon-600 hover:bg-salmon-700 text-white disabled:opacity-40 transition-colors"
          >
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        {!showNewForm && (
          <button
            onClick={openNew}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold bg-salmon-600 hover:bg-salmon-700 text-white transition-colors"
          >
                  ...
                  {!isEditing && (
                    <>
                      <button
                        ...
                        className="flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-medium bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-salmon-50 dark:hover:bg-navy-950/40 hover:text-salmon-600 dark:hover:text-salmon-400 transition-colors"
                      >
                  ...
                  <div className="flex flex-wrap gap-3 items-end">
                    ...
                    <div className="flex gap-2 pb-0.5">
                      <button
                        ...
                        disabled={savingEdit}
                        className="px-3 py-1.5 rounded-lg text-xs font-bold bg-salmon-600 hover:bg-salmon-700 text-white disabled:opacity-40 transition-colors"
                      >
